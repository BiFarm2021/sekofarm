...
const MyStats = () => {
  ...
  const myprice = new BigNumber(becoPrice).toNumber()
          ...
          <TvlBox>
            {tvl ? (
              <>
                ...
                <Text fontSize="12px" color="textSubtle">{t('Across all LPs and BiYield Pools')}</Text>
              </>
            ) : (
              <Skeleton height={66} />
            )}
          ...
          <StatsBox>
            <div>
              <Row>
                ...
                <Row>
                <Text fontSize="13px" color="textSubtle">{t('BiYield Price')}</Text>
                <Text fontSize="18px" bold>{myprice}</Text>
            ...
            <div>
              <Row>
                <Text fontSize="13px" color="textSubtle">{t('Circulating BiYield Supply')}</Text>
                {becoSupply && <CardValue fontSize="18px" value={becoSupply} />}
              </Row>
              <Row>
                <Text fontSize="13px" color="textSubtle">{t('Total BiYield Burned')}</Text>
                <CardValue fontSize="18px" decimals={0} value={burnedBalance} />
              </Row>
            </div>
            <div>
              <Row>
                <Text fontSize="13px" color="textSubtle">{t('New BiYield/block')}</Text>
                <Text fontSize="18px" bold>{t('0.05')}</Text>
              </Row>
              <Row>
                <Text fontSize="13px" color="textSubtle">{t('Initial Price')}</Text>
                <Text fontSize="18px" bold>$0.033</Text>
              </Row>
            </div>
          </StatsBox>
        </BecoStatsContent>
